  ...
  return (
    <Accordion.Item eventKey="Versiohistoria">
      ...
      <Accordion.Body>
        ...
        <p>
          Lisätty Museoviraston muinaisjäännösrekisterin löytöpaikat,
        ...
        <h6>Joulukuu 2020</h6>
        <p>
          Lisätty Ahvenanmaan muinaisjäännösrekisterin kohteisiin tyyppi,
          ajoitus ja alakohteiden lukumäärä.
        </p>
        <p>
        ...
        <h6>Helmikuu 2020</h6>
        <p>
          Lisätty kartta-aineistojen viimeisin päivitysaika näkyviin
          "Lisätietoja sivustosta" -sivulle.
        </p>
