...
class MuinaismuistotImport {
	...
	protected function dropAndCreateMuinaismuistopisteFinalTable() {
		$createTableSql = "
			CREATE TABLE MUINAISJAANNOSPISTE (
			  ...
			  PRIMARY KEY (ID),
			  CONSTRAINT fk_MUINAISJAANNOSPISTE_KUNTA FOREIGN KEY (KUNTA) REFERENCES KUNTA(ID),
			  CONSTRAINT fk_MUINAISJAANNOSPISTE_MAAKUNTA FOREIGN KEY (MAAKUNTA_ID) REFERENCES MAAKUNTA(ID),
			  CONSTRAINT fk_MUINAISJAANNOSPISTE_TYYPPI FOREIGN KEY (TYYPPI) REFERENCES TYYPPI(ID),
			  CONSTRAINT fk_MUINAISJAANNOSPISTE_ALATYYPPI FOREIGN KEY (ALATYYPPI) REFERENCES ALATYYPPI(ID),
			  CONSTRAINT fk_MUINAISJAANNOSPISTE_LAJI FOREIGN KEY (LAJI) REFERENCES LAJI(ID)
			) ENGINE=InnoDB DEFAULT CHARSET=utf8;
		";
		$this->pdo->query($createTableSql);
	...
	protected function copyMuinaismuistopisteFromWorkToFinal() {
		$sql = "
			INSERT INTO MUINAISJAANNOSPISTE(X,Y,KUNTA,MAAKUNTA_ID,MJTUNNUS,KOHDENIMI,TYYPPI,ALATYYPPI,LAJI,PAIKANNUST,PAIKANNU0,SELITE,TUHOUTUNUT,LUONTIPVM,MUUTOSPVM,ZALA,ZYLA,VEDENALAIN)
			SELECT X,Y,KUNTA,MAAKUNTA_ID,MJTUNNUS,KOHDENIMI,TYYPPI,ALATYYPPI,LAJI,PAIKANNUST,PAIKANNU0,SELITE,TUHOUTUNUT,LUONTIPVM,MUUTOSPVM,ZALA,ZYLA,VEDENALAIN
