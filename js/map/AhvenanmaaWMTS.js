var AhvenanmaaWMTS = function(showLoadingAnimationFn, onLayerCreatedCallbackFn) {
  ...
  */
  var calculateAhvenanmaaWMTSResolution = function(clickedViewProjectionCoordinate, viewProjection, viewZoomLevel) {
  ...
  */
  var calculateClickedAhvenanmaaWMTSTilePixel = function(clickedCoordinateInAhvenanmaaWMTSProjection, ahvenanmaaWMTSResolution) {
    var tileGrid = source.getTileGrid();
    ...
    var y = Math.floor((tileExtent[3] - clickedCoordinateInAhvenanmaaWMTSProjection[1]) / (ahvenanmaaWMTSResolution / pixelRatio));
  ...
  *  &J=210"
  */
  var getFeatureInfoUrl = function(clickedCoordinateInAhvenanmaaWMTSProjection, ahvenanmaaWMTSZoomLevel, clickedAhvenanmaaWMTSTilePixel) {
    var tileGrid = source.getTileGrid();
    var tileCoord = tileGrid.getTileCoordForCoordAndZ(clickedCoordinateInAhvenanmaaWMTSProjection, ahvenanmaaWMTSZoomLevel);
    ...
    return tileUrl.replace('Request=GetTile', 'Request=GetFeatureInfo') +
      '&INFOFORMAT=' + encodeURIComponent('application/json') +
      '&I=' + clickedAhvenanmaaWMTSTilePixel[0] +
      '&J=' + clickedAhvenanmaaWMTSTilePixel[1];
  };
  ...
  */
  this.getFeatureInfo = function(clickedViewProjectionCoordinate, viewProjection, viewZoomLevel) {
    ...
    var featureInfoUrl = getFeatureInfoUrl(clickedCoordinateInAhvenanmaaWMTSProjection, ahvenanmaaWMTSZoomLevel, clickedAhvenanmaaWMTSTilePixel);
