...

{
  ...
  echo "- MVT-feature-ID on GeoPackagen \`fid\`. Se yhdistää PMTiles-featuren saman aineistojulkaisun D1-riviin avaimella \`source_layer + fid\`, mutta sen ei oleteta säilyvän julkaisusta toiseen."
  echo "- Pysyvät linkit käyttävät yhdistelmää \`logical_layer_id + registry_id\`. Sama rekisteritunnus voi vastata useita lähderivejä, joten D1 palauttaa kaikki nykyisen aineiston osumat eikä deduplikoi geometrioita."
