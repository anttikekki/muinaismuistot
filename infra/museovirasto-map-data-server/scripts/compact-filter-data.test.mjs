...
const transformer = join(project, "scripts/compact-filter-data.mjs")
const vocabulary = join(project, "poc/web/filter-vocabulary.json")
const mapping = join(project, "layer-mapping.json")
