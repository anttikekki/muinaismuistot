...
run_step "Validate downloaded source data" "$SCRIPT_DIR/validation/validate-source-data.sh"
run_step "Build compact PMTiles" "$SCRIPT_DIR/02-build-pmtiles.sh"
run_step "Validate compact PMTiles" "$SCRIPT_DIR/validation/validate-pmtiles.sh" "$ARCHIVE"
...
run_step "Validate PMTiles and D1 identities" "$SCRIPT_DIR/validation/validate-pmtiles-d1-identities.sh"
