...
tiedostossa [`docs/IMPLEMENTATION_PLAN.md`](docs/IMPLEMENTATION_PLAN.md).
...
Tietuemäärät kuvaavat yhtä ladattua tuotantoaineistoversiota ja muuttuvat aineiston päivittyessä. Tarkempi generoitu skeema- ja arvojoukkoanalyysi on tiedostossa [SOURCE_DATA_INVENTORY.md](docs/SOURCE_DATA_INVENTORY.md).
