/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: be029e57f596685dafd4c4f7ae490794)
...
interface __BaseEnv_Env {
	...
	BASE_URL: "https://muinaismuistot-preview.antti-kekki.workers.dev" | "https://muinaismuistot.info";
	MAX_SOURCE_AGE_HOURS: "36";
	UPDATE_CONTAINER: DurableObjectNamespace<import("./src/index").MapDataUpdateContainer>;
	UPDATE_WORKFLOW: Workflow<Parameters<import("./src/index").MapDataUpdateWorkflow['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "MapDataUpdateContainer";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "TARGET_ENV" | "BASE_URL" | "MAX_SOURCE_AGE_HOURS">> {}
}
