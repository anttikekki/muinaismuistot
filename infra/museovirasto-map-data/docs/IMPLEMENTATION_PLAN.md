...
- [x] Tee toistettava rakennusskripti paikalliseen ja konttiajoon. Yöajo validoi vain päivittäin vaihtuvan lähdeaineiston ja rakennetut artefaktit; työkalujen, mappingin ja muunnoskoodin staattiset tarkistukset ajetaan kehityksessä erikseen. Ohje on tiedostossa [BUILD_PIPELINE.md](BUILD_PIPELINE.md).
...
- [x] Validoi odotetut tiedostot, tasot, geometriatyypit, EPSG:3067-koordinaatisto ja geometriat ilman päivittäisen rivimäärän snapshot-vertailua. Tuntematon suodatuksessa tarvittava koodiarvo estää rakennuksen, koska selain ei voisi tulkita sitä oikein.
